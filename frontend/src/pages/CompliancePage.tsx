...
const Sidebar: React.FC = () => (
  <aside className="fixed left-0 top-0 h-full w-[240px] bg-[#F5F5F5] border-r border-[#E0E0E0] flex flex-col py-6 z-30" style={{fontFamily:'Inter,sans-serif'}}>
    <div className="px-6 mb-10">
      <h1 className="text-[24px] font-bold text-[#004D40]" style={{lineHeight:1.3}}>The Cockpit</h1>
      <p className="text-[13px] font-[JetBrains_Mono,monospace] text-[#616161] uppercase tracking-widest mt-1 font-medium">Reliability Engineer</p>
    </div>
    <nav className="flex-1 space-y-1">
      {[
        {to:'/', icon:'smart_toy', label:'Copilot'},
        {to:'/rca', icon:'analytics', label:'RCA Dashboard'},
        {to:'/compliance', icon:'fact_check', label:'Compliance', exact:true},
